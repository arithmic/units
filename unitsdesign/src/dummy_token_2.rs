...
pub struct DummyToken2<V: SignatureVerifier, S: StateManager> {
    issuer_id: Address,
    token_type: u8,
    verifier: V,
    state_manager: S,
...
impl<V: SignatureVerifier, S: StateManager> DummyToken2<V, S> {
...
impl<V: SignatureVerifier, S: StateManager> TokenContract for DummyToken2<V, S> {
    fn mint(
        &self,
