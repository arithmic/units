...
pub struct AadhaarToken<V: SignatureVerifier, S: StateManager> {
    issuer_id: Address,
    token_type: u8,
    verifier: V,
    state_manager: S,
...
impl<V: SignatureVerifier, S: StateManager> AadhaarToken<V, S> {
...
impl<V: SignatureVerifier, S: StateManager> TokenContract for AadhaarToken<V, S> {
    fn mint(
        &self,
